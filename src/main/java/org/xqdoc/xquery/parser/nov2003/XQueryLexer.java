...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("type", this), new Integer(144));
	literals.put(new ANTLRHashString("treat", this), new Integer(71));
	literals.put(new ANTLRHashString("typeswitch", this), new Integer(34));
	...
	literals.put(new ANTLRHashString("case", this), new Integer(64));
	literals.put(new ANTLRHashString("option", this), new Integer(23));
	literals.put(new ANTLRHashString("delete", this), new Integer(40));
	literals.put(new ANTLRHashString("ne", this), new Integer(77));
	literals.put(new ANTLRHashString("validate", this), new Integer(97));
	literals.put(new ANTLRHashString("le", this), new Integer(79));
	literals.put(new ANTLRHashString("greatest", this), new Integer(61));
	literals.put(new ANTLRHashString("ancestor-or-self", this), new Integer(123));
	literals.put(new ANTLRHashString("descendant-or-self", this), new Integer(119));
	literals.put(new ANTLRHashString("insert", this), new Integer(39));
	literals.put(new ANTLRHashString("variable", this), new Integer(17));
	literals.put(new ANTLRHashString("where", this), new Integer(54));
	literals.put(new ANTLRHashString("stable", this), new Integer(55));
	literals.put(new ANTLRHashString("then", this), new Integer(65));
	literals.put(new ANTLRHashString("preceding", this), new Integer(49));
	literals.put(new ANTLRHashString("document-node", this), new Integer(105));
	literals.put(new ANTLRHashString("collation", this), new Integer(13));
	literals.put(new ANTLRHashString("xmlspace", this), new Integer(10));
	literals.put(new ANTLRHashString("to", this), new Integer(86));
	literals.put(new ANTLRHashString("and", this), new Integer(68));
	literals.put(new ANTLRHashString("module", this), new Integer(6));
	literals.put(new ANTLRHashString("strip", this), new Integer(140));
	literals.put(new ANTLRHashString("return", this), new Integer(51));
	literals.put(new ANTLRHashString("strict", this), new Integer(146));
	literals.put(new ANTLRHashString("context", this), new Integer(113));
	literals.put(new ANTLRHashString("schema", this), new Integer(19));
	literals.put(new ANTLRHashString("external", this), new Integer(28));
	literals.put(new ANTLRHashString("validation", this), new Integer(18));
	literals.put(new ANTLRHashString("mod", this), new Integer(92));
	literals.put(new ANTLRHashString("following", this), new Integer(50));
	literals.put(new ANTLRHashString("except", this), new Integer(96));
	literals.put(new ANTLRHashString("text", this), new Integer(100));
	literals.put(new ANTLRHashString("preserve", this), new Integer(139));
	literals.put(new ANTLRHashString("function", this), new Integer(15));
	literals.put(new ANTLRHashString("with", this), new Integer(47));
	literals.put(new ANTLRHashString("gt", this), new Integer(80));
	literals.put(new ANTLRHashString("global", this), new Integer(112));
	literals.put(new ANTLRHashString("preceding-sibling", this), new Integer(124));
	literals.put(new ANTLRHashString("intersect", this), new Integer(95));
	literals.put(new ANTLRHashString("version", this), new Integer(5));
	literals.put(new ANTLRHashString("at", this), new Integer(22));
	literals.put(new ANTLRHashString("of", this), new Integer(70));
	literals.put(new ANTLRHashString("is", this), new Integer(85));
	...
	literals.put(new ANTLRHashString("as", this), new Integer(46));
	literals.put(new ANTLRHashString("by", this), new Integer(57));
	literals.put(new ANTLRHashString("catch", this), new Integer(44));
	literals.put(new ANTLRHashString("union", this), new Integer(93));
	literals.put(new ANTLRHashString("try", this), new Integer(43));
	literals.put(new ANTLRHashString("lax", this), new Integer(145));
	literals.put(new ANTLRHashString("order", this), new Integer(56));
	literals.put(new ANTLRHashString("xquery", this), new Integer(4));
	literals.put(new ANTLRHashString("following-sibling", this), new Integer(120));
	literals.put(new ANTLRHashString("node", this), new Integer(101));
	literals.put(new ANTLRHashString("collection", this), new Integer(148));
	literals.put(new ANTLRHashString("some", this), new Integer(32));
	literals.put(new ANTLRHashString("ge", this), new Integer(81));
	literals.put(new ANTLRHashString("declare", this), new Integer(9));
	literals.put(new ANTLRHashString("for", this), new Integer(30));
	literals.put(new ANTLRHashString("ascending", this), new Integer(58));
	literals.put(new ANTLRHashString("eq", this), new Integer(76));
	literals.put(new ANTLRHashString("element", this), new Integer(14));
	literals.put(new ANTLRHashString("default", this), new Integer(12));
	literals.put(new ANTLRHashString("descending", this), new Integer(59));
	literals.put(new ANTLRHashString("castable", this), new Integer(72));
	literals.put(new ANTLRHashString("idiv", this), new Integer(91));
	literals.put(new ANTLRHashString("ancestor", this), new Integer(122));
	literals.put(new ANTLRHashString("instance", this), new Integer(69));
	literals.put(new ANTLRHashString("replace", this), new Integer(37));
	literals.put(new ANTLRHashString("nillable", this), new Integer(143));
	...
	literals.put(new ANTLRHashString("cast", this), new Integer(73));
	literals.put(new ANTLRHashString("value", this), new Integer(38));
	literals.put(new ANTLRHashString("into", this), new Integer(48));
	literals.put(new ANTLRHashString("rename", this), new Integer(41));
	literals.put(new ANTLRHashString("else", this), new Integer(66));
	literals.put(new ANTLRHashString("import", this), new Integer(11));
	literals.put(new ANTLRHashString("lt", this), new Integer(78));
	literals.put(new ANTLRHashString("document", this), new Integer(106));
	literals.put(new ANTLRHashString("in", this), new Integer(52));
	literals.put(new ANTLRHashString("let", this), new Integer(31));
	literals.put(new ANTLRHashString("self", this), new Integer(117));
	literals.put(new ANTLRHashString("base-uri", this), new Integer(16));
	literals.put(new ANTLRHashString("processing-instruction", this), new Integer(104));
	literals.put(new ANTLRHashString("skip", this), new Integer(147));
	literals.put(new ANTLRHashString("parent", this), new Integer(121));
	literals.put(new ANTLRHashString("descendant", this), new Integer(118));
	literals.put(new ANTLRHashString("update", this), new Integer(36));
	literals.put(new ANTLRHashString("every", this), new Integer(33));
	literals.put(new ANTLRHashString("satisfies", this), new Integer(63));
	literals.put(new ANTLRHashString("div", this), new Integer(90));
	literals.put(new ANTLRHashString("item", this), new Integer(142));
