...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("treat", this), new Integer(74));
	literals.put(new ANTLRHashString("typeswitch", this), new Integer(51));
	literals.put(new ANTLRHashString("namespace", this), new Integer(11));
	literals.put(new ANTLRHashString("comment", this), new Integer(44));
	literals.put(new ANTLRHashString("case", this), new Integer(67));
	literals.put(new ANTLRHashString("ne", this), new Integer(80));
	literals.put(new ANTLRHashString("le", this), new Integer(82));
	literals.put(new ANTLRHashString("greatest", this), new Integer(64));
	literals.put(new ANTLRHashString("ancestor-or-self", this), new Integer(118));
	...
	literals.put(new ANTLRHashString("stable", this), new Integer(59));
	literals.put(new ANTLRHashString("then", this), new Integer(68));
	literals.put(new ANTLRHashString("preceding", this), new Integer(119));
	literals.put(new ANTLRHashString("document-node", this), new Integer(41));
	...
	literals.put(new ANTLRHashString("and", this), new Integer(71));
	...
	literals.put(new ANTLRHashString("strict", this), new Integer(20));
	literals.put(new ANTLRHashString("schema", this), new Integer(22));
	...
	literals.put(new ANTLRHashString("text", this), new Integer(45));
	...
	literals.put(new ANTLRHashString("at", this), new Integer(25));
	literals.put(new ANTLRHashString("of", this), new Integer(73));
	literals.put(new ANTLRHashString("is", this), new Integer(88));
	literals.put(new ANTLRHashString("or", this), new Integer(70));
	literals.put(new ANTLRHashString("if", this), new Integer(52));
	literals.put(new ANTLRHashString("least", this), new Integer(65));
	literals.put(new ANTLRHashString("as", this), new Integer(34));
	literals.put(new ANTLRHashString("by", this), new Integer(61));
	...
	literals.put(new ANTLRHashString("lax", this), new Integer(19));
	literals.put(new ANTLRHashString("order", this), new Integer(60));
	literals.put(new ANTLRHashString("xquery", this), new Integer(5));
	literals.put(new ANTLRHashString("following-sibling", this), new Integer(115));
	literals.put(new ANTLRHashString("node", this), new Integer(46));
	...
	literals.put(new ANTLRHashString("ascending", this), new Integer(62));
	literals.put(new ANTLRHashString("define", this), new Integer(16));
	literals.put(new ANTLRHashString("eq", this), new Integer(79));
	literals.put(new ANTLRHashString("isnot", this), new Integer(89));
	literals.put(new ANTLRHashString("element", this), new Integer(14));
	literals.put(new ANTLRHashString("default", this), new Integer(12));
	literals.put(new ANTLRHashString("descending", this), new Integer(63));
	literals.put(new ANTLRHashString("castable", this), new Integer(75));
	literals.put(new ANTLRHashString("idiv", this), new Integer(93));
	literals.put(new ANTLRHashString("ancestor", this), new Integer(117));
	literals.put(new ANTLRHashString("property", this), new Integer(109));
	literals.put(new ANTLRHashString("instance", this), new Integer(72));
	literals.put(new ANTLRHashString("nillable", this), new Integer(124));
	literals.put(new ANTLRHashString("attribute", this), new Integer(42));
	literals.put(new ANTLRHashString("empty", this), new Integer(36));
	literals.put(new ANTLRHashString("cast", this), new Integer(76));
	literals.put(new ANTLRHashString("else", this), new Integer(69));
	literals.put(new ANTLRHashString("import", this), new Integer(8));
	literals.put(new ANTLRHashString("lt", this), new Integer(81));
	literals.put(new ANTLRHashString("document", this), new Integer(101));
	literals.put(new ANTLRHashString("in", this), new Integer(57));
	literals.put(new ANTLRHashString("let", this), new Integer(48));
	literals.put(new ANTLRHashString("self", this), new Integer(111));
	literals.put(new ANTLRHashString("processing-instruction", this), new Integer(43));
	literals.put(new ANTLRHashString("skip", this), new Integer(21));
	literals.put(new ANTLRHashString("parent", this), new Integer(116));
	...
	literals.put(new ANTLRHashString("satisfies", this), new Integer(66));
	literals.put(new ANTLRHashString("div", this), new Integer(92));
	literals.put(new ANTLRHashString("item", this), new Integer(40));
	literals.put(new ANTLRHashString("child", this), new Integer(110));
}
