...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("treat", this), new Integer(93));
	literals.put(new ANTLRHashString("typeswitch", this), new Integer(51));
	literals.put(new ANTLRHashString("copy-namespaces", this), new Integer(19));
	literals.put(new ANTLRHashString("namespace", this), new Integer(7));
	literals.put(new ANTLRHashString("no-preserve", this), new Integer(34));
	literals.put(new ANTLRHashString("comment", this), new Integer(103));
	literals.put(new ANTLRHashString("case", this), new Integer(63));
	literals.put(new ANTLRHashString("option", this), new Integer(25));
	literals.put(new ANTLRHashString("ne", this), new Integer(71));
	literals.put(new ANTLRHashString("validate", this), new Integer(96));
	literals.put(new ANTLRHashString("le", this), new Integer(73));
	literals.put(new ANTLRHashString("greatest", this), new Integer(32));
	literals.put(new ANTLRHashString("ancestor-or-self", this), new Integer(122));
	literals.put(new ANTLRHashString("descendant-or-self", this), new Integer(117));
	literals.put(new ANTLRHashString("variable", this), new Integer(24));
	literals.put(new ANTLRHashString("where", this), new Integer(57));
	literals.put(new ANTLRHashString("stable", this), new Integer(58));
	literals.put(new ANTLRHashString("construction", this), new Integer(16));
	literals.put(new ANTLRHashString("then", this), new Integer(64));
	literals.put(new ANTLRHashString("preceding", this), new Integer(123));
	literals.put(new ANTLRHashString("document-node", this), new Integer(105));
	literals.put(new ANTLRHashString("collation", this), new Integer(14));
	...
	literals.put(new ANTLRHashString("strip", this), new Integer(28));
	literals.put(new ANTLRHashString("return", this), new Integer(55));
	literals.put(new ANTLRHashString("strict", this), new Integer(146));
	literals.put(new ANTLRHashString("inherit", this), new Integer(36));
	literals.put(new ANTLRHashString("schema", this), new Integer(21));
	literals.put(new ANTLRHashString("external", this), new Integer(41));
	literals.put(new ANTLRHashString("unordered", this), new Integer(30));
	literals.put(new ANTLRHashString("ordered", this), new Integer(29));
	literals.put(new ANTLRHashString("mod", this), new Integer(86));
	literals.put(new ANTLRHashString("following", this), new Integer(118));
	literals.put(new ANTLRHashString("except", this), new Integer(90));
	literals.put(new ANTLRHashString("text", this), new Integer(100));
	literals.put(new ANTLRHashString("preserve", this), new Integer(27));
	literals.put(new ANTLRHashString("function", this), new Integer(23));
	literals.put(new ANTLRHashString("gt", this), new Integer(74));
	literals.put(new ANTLRHashString("preceding-sibling", this), new Integer(124));
	literals.put(new ANTLRHashString("intersect", this), new Integer(89));
	literals.put(new ANTLRHashString("version", this), new Integer(5));
	literals.put(new ANTLRHashString("at", this), new Integer(38));
	...
	literals.put(new ANTLRHashString("least", this), new Integer(33));
	literals.put(new ANTLRHashString("as", this), new Integer(44));
	literals.put(new ANTLRHashString("by", this), new Integer(59));
	literals.put(new ANTLRHashString("catch", this), new Integer(54));
	literals.put(new ANTLRHashString("union", this), new Integer(87));
	literals.put(new ANTLRHashString("try", this), new Integer(53));
	literals.put(new ANTLRHashString("lax", this), new Integer(145));
	literals.put(new ANTLRHashString("order", this), new Integer(18));
	literals.put(new ANTLRHashString("xquery", this), new Integer(4));
	literals.put(new ANTLRHashString("following-sibling", this), new Integer(119));
	literals.put(new ANTLRHashString("node", this), new Integer(101));
	literals.put(new ANTLRHashString("some", this), new Integer(49));
	literals.put(new ANTLRHashString("ge", this), new Integer(75));
	literals.put(new ANTLRHashString("declare", this), new Integer(11));
	literals.put(new ANTLRHashString("for", this), new Integer(47));
	literals.put(new ANTLRHashString("ascending", this), new Integer(60));
	literals.put(new ANTLRHashString("eq", this), new Integer(70));
	literals.put(new ANTLRHashString("element", this), new Integer(22));
	literals.put(new ANTLRHashString("default", this), new Integer(13));
	literals.put(new ANTLRHashString("descending", this), new Integer(61));
	literals.put(new ANTLRHashString("castable", this), new Integer(94));
	literals.put(new ANTLRHashString("idiv", this), new Integer(85));
	literals.put(new ANTLRHashString("boundary-space", this), new Integer(12));
	literals.put(new ANTLRHashString("ancestor", this), new Integer(121));
	literals.put(new ANTLRHashString("ordering", this), new Integer(17));
	literals.put(new ANTLRHashString("instance", this), new Integer(91));
	literals.put(new ANTLRHashString("no-inherit", this), new Integer(37));
	literals.put(new ANTLRHashString("attribute", this), new Integer(102));
	literals.put(new ANTLRHashString("empty", this), new Integer(31));
	literals.put(new ANTLRHashString("cast", this), new Integer(95));
	literals.put(new ANTLRHashString("encoding", this), new Integer(9));
	literals.put(new ANTLRHashString("schema-element", this), new Integer(107));
	literals.put(new ANTLRHashString("else", this), new Integer(65));
	literals.put(new ANTLRHashString("import", this), new Integer(20));
	literals.put(new ANTLRHashString("lt", this), new Integer(72));
	literals.put(new ANTLRHashString("document", this), new Integer(108));
	literals.put(new ANTLRHashString("in", this), new Integer(56));
	literals.put(new ANTLRHashString("let", this), new Integer(48));
	literals.put(new ANTLRHashString("self", this), new Integer(115));
	literals.put(new ANTLRHashString("base-uri", this), new Integer(15));
	literals.put(new ANTLRHashString("processing-instruction", this), new Integer(104));
	literals.put(new ANTLRHashString("void", this), new Integer(142));
	literals.put(new ANTLRHashString("parent", this), new Integer(120));
	literals.put(new ANTLRHashString("descendant", this), new Integer(116));
	literals.put(new ANTLRHashString("every", this), new Integer(50));
	literals.put(new ANTLRHashString("satisfies", this), new Integer(62));
	literals.put(new ANTLRHashString("div", this), new Integer(84));
	literals.put(new ANTLRHashString("item", this), new Integer(143));
	literals.put(new ANTLRHashString("child", this), new Integer(114));
	literals.put(new ANTLRHashString("schema-attribute", this), new Integer(106));
}
...
tryAgain:
	...
	protected final void mDIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_2.member(LA(1)))) {
				...
				if ( _cnt1714>=1 ) { break _loop1714; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mHEX_DIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1717>=1 ) { break _loop1717; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1717++;
		} while (true);
	...
	protected final void mWS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1727>=1 ) { break _loop1727; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1727++;
		} while (true);
	...
	protected final void mEXPR_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			else if ((_tokenSet_7.member(LA(1))) && (_tokenSet_6.member(LA(2))) && (_tokenSet_6.member(LA(3))) && (true)) {
				mCHAR(false);
			}
			else {
				boolean synPredMatched1732 = false;
				if (((LA(1)==':') && (_tokenSet_6.member(LA(2))) && (_tokenSet_6.member(LA(3))) && (true))) {
					int _m1732 = mark();
					synPredMatched1732 = true;
					inputState.guessing++;
					try {
						{
						match(':');
						...
						synPredMatched1732 = false;
					}
					rewind(_m1732);
					inputState.guessing--;
				}
				if ( synPredMatched1732 ) {
					match(':');
				}
				else {
					break _loop1735;
	...
	protected final void mXQDOC_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop1741:
		do {
			boolean synPredMatched1740 = false;
			if (((LA(1)==':') && (_tokenSet_6.member(LA(2))) && (_tokenSet_6.member(LA(3))))) {
				int _m1740 = mark();
				synPredMatched1740 = true;
				inputState.guessing++;
				try {
					{
					match(':');
					...
					synPredMatched1740 = false;
				}
				rewind(_m1740);
				inputState.guessing--;
			}
			if ( synPredMatched1740 ) {
				match(':');
			}
	...
	protected final void mPRAGMA(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		mWS(false);
		{
		if ((_tokenSet_9.member(LA(1))) && (_tokenSet_7.member(LA(2))) && (_tokenSet_7.member(LA(3)))) {
			mPRAGMA_CONTENT(false);
		}
	...
	protected final void mPRAGMA_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop1751:
		do {
			if ((_tokenSet_7.member(LA(1))) && (_tokenSet_7.member(LA(2))) && (_tokenSet_7.member(LA(3))) && (true)) {
				mCHAR(false);
			}
			else {
				boolean synPredMatched1750 = false;
				if (((LA(1)=='#') && (_tokenSet_7.member(LA(2))) && (_tokenSet_7.member(LA(3))) && (true))) {
					int _m1750 = mark();
					synPredMatched1750 = true;
					inputState.guessing++;
					try {
						{
						match('#');
						...
						synPredMatched1750 = false;
					}
					rewind(_m1750);
					inputState.guessing--;
				}
				if ( synPredMatched1750 ) {
					match('#');
				}
				else {
					if ( _cnt1751>=1 ) { break _loop1751; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1751++;
			} while (true);
	...
	protected final void mQUOT_ATTRIBUTE_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_12.member(LA(1)))) {
				...
				if ( _cnt1787>=1 ) { break _loop1787; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mAPOS_ATTRIBUTE_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_13.member(LA(1)))) {
				...
				if ( _cnt1791>=1 ) { break _loop1791; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mELEMENT_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
				...
				if ( _cnt1794>=1 ) { break _loop1794; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1794++;
		} while (true);
		...
		do {
			if ((_tokenSet_14.member(LA(1)))) {
				...
				if ( synPredMatched1800 ) {
					...
					if ( _cnt1801>=1 ) { break _loop1801; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1801++;
			} while (true);
		...
		do {
			if ((_tokenSet_15.member(LA(1)))) {
				...
				if ( synPredMatched1807 ) {
					...
					if ( _cnt1808>=1 ) { break _loop1808; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1808++;
			} while (true);
	...
	protected final void mXML_PI(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_16.member(LA(1)))) {
				...
				boolean synPredMatched1814 = false;
				if (((LA(1)=='?'))) {
					int _m1814 = mark();
					synPredMatched1814 = true;
					inputState.guessing++;
					try {
						{
						match('?');
						...
						synPredMatched1814 = false;
					}
					rewind(_m1814);
					inputState.guessing--;
				}
				if ( synPredMatched1814 ) {
					match('?');
				}
				else {
					if ( _cnt1815>=1 ) { break _loop1815; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1815++;
			} while (true);
 ...
 */
	public final void mNEXT_TOKEN(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		default:
			...
			if (((LA(1)=='(') && (LA(2)=='#') && (LA(3)=='\t'||LA(3)=='\n'||LA(3)=='\r'||LA(3)==' ') && (_tokenSet_18.member(LA(4))))) {
				int _m1820 = mark();
			...
			if ( synPredMatched1820 ) {
				...
				if ( synPredMatched1822 ) {
					...
					if ( synPredMatched1836 ) {
						...
						boolean synPredMatched1818 = false;
						if (((LA(1)=='<') && (LA(2)=='?'))) {
							int _m1818 = mark();
							synPredMatched1818 = true;
							inputState.guessing++;
							try {
								{
								mXML_PI_START(false);
								...
								synPredMatched1818 = false;
							}
							rewind(_m1818);
							inputState.guessing--;
						}
						if ( synPredMatched1818 ) {
							mXML_PI(false);
							if ( inputState.guessing==0 ) {
								_ttype = XML_PI;
							}
							...
							if ((((LA(1)=='.') && (LA(2)=='.') && (true) && (true))&&( !(inAttributeContent || inElementContent) ))) {
								...
								try {
									...
									synPredMatched1824 = false;
								}
								rewind(_m1824);
								inputState.guessing--;
							}
							if ( synPredMatched1824 ) {
								mPARENT(false);
								if ( inputState.guessing==0 ) {
									_ttype = PARENT;
								}
								...
								if ( inputState.guessing==0 ) {
											...
											if (wsExplicit) {
												...
												whiteSpaceBag.append(new String(text.getBuffer(),_begin,text.length()-_begin));
												_ttype = Token.SKIP;
											}
								...
								boolean synPredMatched1827 = false;
								if (((_tokenSet_19.member(LA(1))) && (true) && (true) && (true))) {
									int _m1827 = mark();
									synPredMatched1827 = true;
									inputState.guessing++;
									try {
										{
										match('.');
										...
										synPredMatched1827 = false;
									}
									rewind(_m1827);
									inputState.guessing--;
								}
								if ( synPredMatched1827 ) {
									...
									if ( synPredMatched1829 ) {
										...
										boolean synPredMatched1831 = false;
										if (((LA(1)=='.') && (true) && (true) && (true))) {
											int _m1831 = mark();
											synPredMatched1831 = true;
											inputState.guessing++;
											try {
												{
												match('.');
												...
												synPredMatched1831 = false;
											}
											rewind(_m1831);
											inputState.guessing--;
										}
										if ( synPredMatched1831 ) {
											mSELF(false);
											if ( inputState.guessing==0 ) {
												_ttype = SELF;
											}
											...
											boolean synPredMatched1838 = false;
											if (((_tokenSet_19.member(LA(1))) && (true) && (true) && (true))) {
												int _m1838 = mark();
												synPredMatched1838 = true;
												inputState.guessing++;
												try {
													{
													mINTEGER_LITERAL(false);
													...
													synPredMatched1838 = false;
												}
												rewind(_m1838);
												inputState.guessing--;
											}
											if ( synPredMatched1838 ) {
												mDECIMAL_LITERAL(false);
												if ( inputState.guessing==0 ) {
													_ttype = DECIMAL_LITERAL;
												}
