...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("empty-sequence", this), new Integer(142));
...
tryAgain:
	...
	protected final void mDIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_2.member(LA(1)))) {
				...
				if ( _cnt1097>=1 ) { break _loop1097; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mHEX_DIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1100>=1 ) { break _loop1100; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1100++;
		} while (true);
	...
	protected final void mWS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1110>=1 ) { break _loop1110; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1110++;
		} while (true);
	...
	protected final void mXQDOC_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop1124:
		do {
			boolean synPredMatched1123 = false;
			if (((LA(1)==':') && (_tokenSet_6.member(LA(2))) && (_tokenSet_6.member(LA(3))))) {
				int _m1123 = mark();
				synPredMatched1123 = true;
				inputState.guessing++;
				try {
					{
					match(':');
					...
					synPredMatched1123 = false;
				}
				rewind(_m1123);
				inputState.guessing--;
			}
			if ( synPredMatched1123 ) {
				match(':');
			}
			...
			if ((_tokenSet_7.member(LA(1))) && (_tokenSet_7.member(LA(2))) && (_tokenSet_7.member(LA(3))) && (true)) {
				...
				if (((LA(1)=='#') && (_tokenSet_7.member(LA(2))) && (_tokenSet_7.member(LA(3))) && (true))) {
					...
					try {
						...
						synPredMatched1133 = false;
					}
					rewind(_m1133);
					inputState.guessing--;
				}
				if ( synPredMatched1133 ) {
					match('#');
				}
				else {
					if ( _cnt1134>=1 ) { break _loop1134; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1134++;
			} while (true);
	...
	protected final void mAPOS_ATTRIBUTE_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_13.member(LA(1)))) {
				...
				if ( _cnt1174>=1 ) { break _loop1174; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		do {
			if ((_tokenSet_14.member(LA(1)))) {
				...
				if ( synPredMatched1183 ) {
					...
					if ( _cnt1184>=1 ) { break _loop1184; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1184++;
			} while (true);
		...
		do {
			if ((_tokenSet_16.member(LA(1)))) {
				...
				if ( synPredMatched1197 ) {
					...
					if ( _cnt1198>=1 ) { break _loop1198; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt1198++;
			} while (true);
