...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("treat", this), new Integer(105));
	literals.put(new ANTLRHashString("typeswitch", this), new Integer(53));
	...
	literals.put(new ANTLRHashString("comment", this), new Integer(115));
	literals.put(new ANTLRHashString("case", this), new Integer(75));
	literals.put(new ANTLRHashString("option", this), new Integer(25));
	literals.put(new ANTLRHashString("delete", this), new Integer(58));
	literals.put(new ANTLRHashString("ne", this), new Integer(83));
	literals.put(new ANTLRHashString("validate", this), new Integer(108));
	literals.put(new ANTLRHashString("le", this), new Integer(85));
	literals.put(new ANTLRHashString("greatest", this), new Integer(32));
	literals.put(new ANTLRHashString("ancestor-or-self", this), new Integer(133));
	literals.put(new ANTLRHashString("descendant-or-self", this), new Integer(129));
	literals.put(new ANTLRHashString("insert", this), new Integer(57));
	literals.put(new ANTLRHashString("variable", this), new Integer(24));
	literals.put(new ANTLRHashString("where", this), new Integer(69));
	literals.put(new ANTLRHashString("stable", this), new Integer(70));
	literals.put(new ANTLRHashString("construction", this), new Integer(16));
	literals.put(new ANTLRHashString("then", this), new Integer(76));
	literals.put(new ANTLRHashString("preceding", this), new Integer(65));
	literals.put(new ANTLRHashString("document-node", this), new Integer(117));
	...
	literals.put(new ANTLRHashString("strict", this), new Integer(156));
	...
	literals.put(new ANTLRHashString("mod", this), new Integer(98));
	literals.put(new ANTLRHashString("following", this), new Integer(66));
	literals.put(new ANTLRHashString("except", this), new Integer(102));
	...
	literals.put(new ANTLRHashString("gt", this), new Integer(86));
	literals.put(new ANTLRHashString("preceding-sibling", this), new Integer(134));
	...
	literals.put(new ANTLRHashString("is", this), new Integer(91));
	literals.put(new ANTLRHashString("empty-sequence", this), new Integer(152));
	...
	literals.put(new ANTLRHashString("catch", this), new Integer(62));
	literals.put(new ANTLRHashString("union", this), new Integer(99));
	literals.put(new ANTLRHashString("try", this), new Integer(61));
	literals.put(new ANTLRHashString("lax", this), new Integer(155));
	literals.put(new ANTLRHashString("order", this), new Integer(18));
	literals.put(new ANTLRHashString("xquery", this), new Integer(4));
	literals.put(new ANTLRHashString("following-sibling", this), new Integer(130));
	literals.put(new ANTLRHashString("node", this), new Integer(113));
	literals.put(new ANTLRHashString("some", this), new Integer(51));
	literals.put(new ANTLRHashString("ge", this), new Integer(87));
	...
	literals.put(new ANTLRHashString("eq", this), new Integer(82));
	...
	literals.put(new ANTLRHashString("idiv", this), new Integer(97));
	literals.put(new ANTLRHashString("boundary-space", this), new Integer(12));
	literals.put(new ANTLRHashString("ancestor", this), new Integer(132));
	...
	literals.put(new ANTLRHashString("replace", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("value", this), new Integer(56));
	literals.put(new ANTLRHashString("encoding", this), new Integer(9));
	literals.put(new ANTLRHashString("into", this), new Integer(64));
	literals.put(new ANTLRHashString("schema-element", this), new Integer(119));
	literals.put(new ANTLRHashString("rename", this), new Integer(59));
	literals.put(new ANTLRHashString("else", this), new Integer(77));
	literals.put(new ANTLRHashString("import", this), new Integer(20));
	literals.put(new ANTLRHashString("lt", this), new Integer(84));
	literals.put(new ANTLRHashString("document", this), new Integer(120));
	literals.put(new ANTLRHashString("in", this), new Integer(68));
	literals.put(new ANTLRHashString("let", this), new Integer(50));
	literals.put(new ANTLRHashString("self", this), new Integer(127));
	literals.put(new ANTLRHashString("base-uri", this), new Integer(15));
	literals.put(new ANTLRHashString("processing-instruction", this), new Integer(116));
	literals.put(new ANTLRHashString("parent", this), new Integer(131));
	literals.put(new ANTLRHashString("descendant", this), new Integer(128));
	literals.put(new ANTLRHashString("update", this), new Integer(54));
	literals.put(new ANTLRHashString("every", this), new Integer(52));
	literals.put(new ANTLRHashString("satisfies", this), new Integer(74));
	literals.put(new ANTLRHashString("item", this), new Integer(153));
	literals.put(new ANTLRHashString("div", this), new Integer(96));
	literals.put(new ANTLRHashString("child", this), new Integer(126));
	literals.put(new ANTLRHashString("schema-attribute", this), new Integer(118));
}
