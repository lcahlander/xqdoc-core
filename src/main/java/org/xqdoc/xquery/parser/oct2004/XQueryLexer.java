...
public XQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("type", this), new Integer(147));
	literals.put(new ANTLRHashString("treat", this), new Integer(91));
	literals.put(new ANTLRHashString("typeswitch", this), new Integer(49));
	literals.put(new ANTLRHashString("namespace", this), new Integer(7));
	literals.put(new ANTLRHashString("comment", this), new Integer(100));
	literals.put(new ANTLRHashString("case", this), new Integer(61));
	literals.put(new ANTLRHashString("ne", this), new Integer(69));
	literals.put(new ANTLRHashString("validate", this), new Integer(94));
	literals.put(new ANTLRHashString("le", this), new Integer(71));
	literals.put(new ANTLRHashString("greatest", this), new Integer(31));
	literals.put(new ANTLRHashString("ancestor-or-self", this), new Integer(119));
	literals.put(new ANTLRHashString("descendant-or-self", this), new Integer(114));
	literals.put(new ANTLRHashString("variable", this), new Integer(24));
	literals.put(new ANTLRHashString("where", this), new Integer(55));
	literals.put(new ANTLRHashString("stable", this), new Integer(56));
	literals.put(new ANTLRHashString("construction", this), new Integer(16));
	literals.put(new ANTLRHashString("then", this), new Integer(62));
	literals.put(new ANTLRHashString("preceding", this), new Integer(120));
	literals.put(new ANTLRHashString("document-node", this), new Integer(102));
	literals.put(new ANTLRHashString("collation", this), new Integer(14));
	literals.put(new ANTLRHashString("xmlspace", this), new Integer(12));
	...
	literals.put(new ANTLRHashString("strip", this), new Integer(27));
	literals.put(new ANTLRHashString("return", this), new Integer(53));
	literals.put(new ANTLRHashString("strict", this), new Integer(142));
	literals.put(new ANTLRHashString("schema", this), new Integer(21));
	literals.put(new ANTLRHashString("external", this), new Integer(39));
	literals.put(new ANTLRHashString("no", this), new Integer(34));
	literals.put(new ANTLRHashString("validation", this), new Integer(148));
	literals.put(new ANTLRHashString("unordered", this), new Integer(29));
	literals.put(new ANTLRHashString("ordered", this), new Integer(28));
	literals.put(new ANTLRHashString("mod", this), new Integer(84));
	literals.put(new ANTLRHashString("following", this), new Integer(115));
	literals.put(new ANTLRHashString("except", this), new Integer(88));
	literals.put(new ANTLRHashString("text", this), new Integer(97));
	literals.put(new ANTLRHashString("preserve", this), new Integer(26));
	literals.put(new ANTLRHashString("function", this), new Integer(23));
	literals.put(new ANTLRHashString("gt", this), new Integer(72));
	literals.put(new ANTLRHashString("preceding-sibling", this), new Integer(121));
	literals.put(new ANTLRHashString("intersect", this), new Integer(87));
	literals.put(new ANTLRHashString("version", this), new Integer(5));
	literals.put(new ANTLRHashString("at", this), new Integer(35));
	literals.put(new ANTLRHashString("of", this), new Integer(90));
	literals.put(new ANTLRHashString("is", this), new Integer(77));
	literals.put(new ANTLRHashString("or", this), new Integer(64));
	literals.put(new ANTLRHashString("if", this), new Integer(50));
	literals.put(new ANTLRHashString("least", this), new Integer(32));
	literals.put(new ANTLRHashString("as", this), new Integer(42));
	literals.put(new ANTLRHashString("by", this), new Integer(57));
	literals.put(new ANTLRHashString("catch", this), new Integer(52));
	literals.put(new ANTLRHashString("union", this), new Integer(85));
	literals.put(new ANTLRHashString("try", this), new Integer(51));
	literals.put(new ANTLRHashString("lax", this), new Integer(141));
	...
	literals.put(new ANTLRHashString("node", this), new Integer(98));
	...
	literals.put(new ANTLRHashString("ge", this), new Integer(73));
	...
	literals.put(new ANTLRHashString("define", this), new Integer(144));
	literals.put(new ANTLRHashString("eq", this), new Integer(68));
	...
	literals.put(new ANTLRHashString("castable", this), new Integer(92));
	literals.put(new ANTLRHashString("idiv", this), new Integer(83));
	...
	literals.put(new ANTLRHashString("yes", this), new Integer(33));
	literals.put(new ANTLRHashString("instance", this), new Integer(89));
	literals.put(new ANTLRHashString("nillable", this), new Integer(146));
	literals.put(new ANTLRHashString("attribute", this), new Integer(99));
	literals.put(new ANTLRHashString("empty", this), new Integer(30));
	literals.put(new ANTLRHashString("cast", this), new Integer(93));
	literals.put(new ANTLRHashString("encoding", this), new Integer(9));
	literals.put(new ANTLRHashString("schema-element", this), new Integer(104));
	literals.put(new ANTLRHashString("else", this), new Integer(63));
	literals.put(new ANTLRHashString("import", this), new Integer(20));
	literals.put(new ANTLRHashString("lt", this), new Integer(70));
	literals.put(new ANTLRHashString("document", this), new Integer(105));
	literals.put(new ANTLRHashString("in", this), new Integer(54));
	literals.put(new ANTLRHashString("let", this), new Integer(46));
	literals.put(new ANTLRHashString("self", this), new Integer(112));
	literals.put(new ANTLRHashString("base-uri", this), new Integer(15));
	literals.put(new ANTLRHashString("processing-instruction", this), new Integer(101));
	literals.put(new ANTLRHashString("parent", this), new Integer(117));
	literals.put(new ANTLRHashString("descendant", this), new Integer(113));
	literals.put(new ANTLRHashString("every", this), new Integer(48));
	literals.put(new ANTLRHashString("inherit-namespaces", this), new Integer(19));
	literals.put(new ANTLRHashString("satisfies", this), new Integer(60));
	literals.put(new ANTLRHashString("div", this), new Integer(82));
	literals.put(new ANTLRHashString("item", this), new Integer(139));
	literals.put(new ANTLRHashString("child", this), new Integer(111));
	literals.put(new ANTLRHashString("schema-attribute", this), new Integer(103));
}
...
tryAgain:
	...
	protected final void mEXTENSION_CONTENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = EXTENSION_CONTENT;
		int _saveIndex;
	...
	protected final void mMU_EXTENSION(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = MU_EXTENSION;
		int _saveIndex;
		String content = null;
